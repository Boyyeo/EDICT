from edict_functions_kd import *
import os 
...
for edit_prompt in ['An Easter cupcake',
                   ...
                   'A rainbow cupcake']:
    print(edit_prompt)
    edited_image = EDICT_editing(im_path,base_prompt, edit_prompt, steps=100,mix_weight=0.93,init_image_strength=0.8,guidance_scale=3)[0]
